    ...
    <div class="container">
        <div class="footer-top">
            <div class="footer-logo">
                <a href="https://www.terryfsieck.com/">
                    <img src="assets/images/logo.png" alt="">
                </a>
            </div>
            <ul class="footer-link">
                <li><a href="https://www.terryfsieck.com/">Home</a></li>
            ...
            <ul class="soccial-media-wrapper">
...
<!-- GSAP + ScrollTrigger + CSSRulePlugin CDN -->
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
    ...
    <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item">
                <a class="nav-link <?php if ($page == 'author-info') {
                                        echo 'active';
                                    } ?>" href="about-author">Author about</a>
            </li>
